...
const HARNESS_CONFIG = (generatedRoot) => [
...
export function currentSide({ repoRoot, hubRoot, workDir, python = process.env.HTML_SHARE_VISUAL_PYTHON ?? 'python' }) {
  ...
  writeFileSync(configFile, HARNESS_CONFIG(generatedRoot), 'utf8');
